export const caseStudies = [
  ...
  },
  {
    ...
    icon: "🚀",
    context:
      "As N26 scaled across Europe, I led core product growth initiatives for the Growth & Engage group — designing a personalized, modular home experience that improved feature discoverability for products like Crypto, Trading, and eSIM, while championing product-led growth and experimentation.",
    problem: [
      "Feature discoverability was low across a growing product surface",
      "Growth depended on faster, higher-velocity experimentation",
      "Onboarding, sign-up, and sign-in funnels carried avoidable friction",
      "High-value products (Crypto, Trading, eSIM) needed better surfacing",
    ],
    roleScope: [
      "Lead PM for the Growth & Engage group",
      "Owned product-led growth, experimentation velocity, and the home experience",
      "Optimized the end-to-end onboarding, sign-up, and sign-in funnel",
      "Partnered with Engineering, Data, UX, and Product Marketing",
    ],
    whatBuilt: [
      "Personalized, modular home experience that improved feature discoverability",
      "Experimentation velocity scaled to 50+ A/B tests per month",
      "Conversion optimization across onboarding, sign-up, and sign-in flows",
      "Growth surfaces for Crypto, Trading, and eSIM",
    ],
    impact: [
      { metric: "MAU Growth", value: "1.8M→5M+" },
      { metric: "Revenue", value: "~$50M / 4yrs" },
      { metric: "A/B Tests", value: "50+/mo" },
