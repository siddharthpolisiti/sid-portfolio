export const caseStudies = [
  ...
  {
    worldNumber: 5,
    title: "SIDE QUEST: YUKI",
    company: "Personal Project",
    role: "AI Digital Assistant",
    icon: "🌟",
    context:
      "Yuki is a personal exploration into AI assistants that actually help, not just chat. The focus is on push intelligence, context awareness, and cost-efficient architectures.",
    problem: [
      "Existing assistants are reactive, not proactive",
      "Users suffer from notification overload and context switching",
      "AI demos rarely translate into real utility",
    ],
    roleScope: [
      "Founder, PM, and early builder",
      "Owned product vision, UX, and architecture decisions",
      "Rapid experimentation without organizational constraints",
    ],
    whatBuilt: [
      "Push-first AI assistant concepts",
      "Inbox intelligence and prioritization",
      "Action-oriented assistant flows",
      "Cost-efficient AI architectures",
      "Trust-first UX principles",
    ],
    impact: [
      { metric: "Prototypes", value: "Rapid" },
      { metric: "Validation", value: "Ongoing" },
      { metric: "Learning", value: "Active" },
      { metric: "Iteration", value: "Fast" },
    ],
    learning:
      "Side quests are where new mechanics are tested before they become main-game systems.",
  },
  {
    worldNumber: 6,
