export const caseStudies = [
  ...
  },
  {
    ...
    icon: "🚀",
    context:
      "As N26 scaled across Europe, I led experimentation and growth for the Growth & Engage group — running the experimentation platform and driving improvements across onboarding, sign-up, and sign-in funnels, then extending into home engagement and feature adoption.",
    problem: [
    ...
    roleScope: [
      ...
      "Owned the experimentation platform and experimentation velocity",
      "Optimized the end-to-end onboarding, sign-up, and sign-in funnels",
      "Partnered with Engineering, Data, UX, and Product Marketing",
    ],
    whatBuilt: [
      "Experimentation platform scaling to 50+ A/B tests per month",
      "Conversion improvements across onboarding, sign-up, and sign-in funnels",
      "Home engagement improvements that lifted feature discoverability and adoption",
    ...
    impact: [
      ...
      { metric: "Focus", value: "Funnels + Adoption" },
    ],
    learning:
